...
// In this version I'm going to add a while loop to checkQueue function
// to see if it will run synchronously with addToQueue function or not
//======================================================================
//----------------------------- Libraries ------------------------------
//======================================================================
#include <stdlib.h>
...
void Cashier::checkQueue(){
		srand(time(0));
		while (allCustomers.size()>0 && customersQ.size()>0) {
