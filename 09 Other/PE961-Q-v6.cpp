//Amir Tajik
//PE961 - version 6 - Oct. 2017
//Khatam University - Performance Evaluation
// In this version I'm going to add the effect of LAMBDA and THETA 
// variables on the process of adding to and picking from Queue.
// Actually, in this code, THETA is not the deadline for the customer, 
// but the rate of picking one out from the queue.
//======================================================================
//----------------------------- Libraries ------------------------------
//======================================================================
#include <stdlib.h>
